...
//if ball collide with pit show message game over you ended up in the pit 
/*if(ball.isTouching(pit)){
  console.log("pit")
  gamestate = 2 
}*/
...
console.log(ball.y)
console.log(ball.body.Ball.position.Y)
console.log(orbit)
  */
